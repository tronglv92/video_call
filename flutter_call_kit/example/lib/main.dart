...
class _MyAppState extends State<HomePage> {
  ...
  Future<void> answerCall(CallKeepPerformAnswerCallAction event) async {
    ...
    print('[vao trong nay answerCall] $callUUID, number: $number');

    _callKeep.startCall(event.callUUID, number, number);
    Timer(const Duration(seconds: 1), () {
      print('[vao trong nay setCurrentCallActive] $callUUID, number: $number');
      _callKeep.setCurrentCallActive(callUUID);
    });
  }

  Future<void> endCall(CallKeepPerformEndCallAction event) async {
    print('vao trong nay endCall: ${event.callUUID}');
    removeCall(event.callUUID);
  }

  Future<void> didPerformDTMFAction(CallKeepDidPerformDTMFAction event) async {
    print('[vao trong nay didPerformDTMFAction] ${event.callUUID}, digits: ${event.digits}');
  }
  ...
  Future<void> didReceiveStartCallAction(
    ...
    print('[vao trong nay didReceiveStartCallAction] $callUUID, number: ${event.handle}');

    _callKeep.startCall(callUUID, event.handle, event.handle);

    Timer(const Duration(seconds: 1), () {
      print('[vao trong nay setCurrentCallActive] $callUUID, number: ${event.handle}');
      _callKeep.setCurrentCallActive(callUUID);
    });
  }
  ...
  Future<void> didPerformSetMutedCallAction(
    ...
    print(
        '[vao trong nay didPerformSetMutedCallAction] ${event.callUUID}, number: $number (${event.muted})');
  ...
  Future<void> didToggleHoldCallAction(
    ...
    final String number = calls[event.callUUID].number;
    print(
        '[vao trong nay didToggleHoldCallAction] ${event.callUUID}, number: $number (${event.hold})');
  ...
  Future<void> setOnHold(String callUUID, bool held) async {
    ...
    print('[vao trong nay setOnHold: $held] $callUUID, number: $handle');
  ...
  Future<void> setMutedCall(String callUUID, bool muted) async {
    ...
    final String handle = calls[callUUID].number;
    print('[vao trong nay setMutedCall: $muted] $callUUID, number: $handle');
  ...
  Future<void> updateDisplay(String callUUID) async {
    ...
    print('[vao trong nay updateDisplay: $number] $callUUID');
  }
  ...
  Future<void> displayIncomingCall(String number) async {
    ...
    print('vao trong nay Display incoming call now');
    ...
    print('[vao trong nay displayIncomingCall] $callUUID number: $number');
  ...
  void onPushKitToken(CallKeepPushKitToken event) {
    print('[vao trong nay onPushKitToken] token => ${event.token}');
  }
