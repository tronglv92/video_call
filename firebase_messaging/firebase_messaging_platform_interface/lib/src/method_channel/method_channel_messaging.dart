      ...
      switch (call.method) {
        ...
        case 'Messaging#onMessageOpenedApp':
          ...
          FirebaseMessagingPlatform.onMessageOpenedApp
              .add(RemoteMessage.fromMap(messageMap));
          break;
        case 'Messaging#onMessageOpenedAppWhenCallAccept':
          print("Messaging#onMessageOpenedAppWhenCallAccept");
          Map<String, dynamic> messageMap =
          Map<String, dynamic>.from(call.arguments);
          FirebaseMessagingPlatform.onMessageOpenedAppWhenCallAccept
              .add(RemoteMessage.fromMap(messageMap));
          break;
